import { solarElevation, isDaytime, solarIntensityFactor } from './solarPosition';
...
describe('isDaytime', () => {
  ...
  it('is consistent with solarElevation > 0', () => {
    expect(isDaytime(0, 0, NOON_JUNE21)).toBe(solarElevation(0, 0, NOON_JUNE21) > 0);
    expect(isDaytime(0, 0, MIDNIGHT_JUNE21)).toBe(solarElevation(0, 0, MIDNIGHT_JUNE21) > 0);
  });
});
