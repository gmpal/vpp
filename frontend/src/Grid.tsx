...
const Grid: React.FC = () => {
    ...
    return (
        <Box sx={{ p: 3 }}>
            <Typography variant="h5" fontWeight="bold" mb={3}>Grid</Typography>

            <Paper elevation={3} sx={{ p: 2, mb: 3, borderRadius: 2 }}>
                <Typography variant="subtitle1" fontWeight="bold" gutterBottom>Load</Typography>
            ...
            <Paper elevation={3} sx={{ p: 2, borderRadius: 2 }}>
                <Typography variant="subtitle1" fontWeight="bold" gutterBottom>Market Price</Typography>
