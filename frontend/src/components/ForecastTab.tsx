...
import {
  Box, Typography, Paper, FormControl, InputLabel, Select, MenuItem, Alert
} from '@mui/material';
import {
  LineChart, Line, XAxis, YAxis, CartesianGrid, Tooltip, ResponsiveContainer, Legend
} from 'recharts';
import { fetchForecastedData, fetchSourceIDs, ForecastedDataPoint } from '../api';
...
const ForecastTab: React.FC = () => {
  ...
  useEffect(() => {
    const sourceIdParam = needsSourceId(selectedSource) ? selectedSourceId : undefined;
    ...
    fetchForecastedData(selectedSource, sourceIdParam)
      ...
      .catch(() => {
        setForecastData([]);
        setError('Failed to fetch forecast data. Check that the backend is running.');
      });
