...
jest.mock('./components/Map3D', () => () => <div data-testid="map3d">Map View</div>);
jest.mock('./components/CommunityDashboard', () => () => <div>Community Dashboard</div>);
jest.mock('./components/HouseholdPanel', () => () => <div>Households &amp; EVs</div>);
jest.mock('./Dashboard', () => () => <div data-testid="dashboard-page">Dashboard Page</div>);
